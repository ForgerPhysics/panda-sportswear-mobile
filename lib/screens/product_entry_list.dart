...
import 'package:panda_sportswear/models/product_entry.dart';
import 'package:panda_sportswear/widgets/drawer.dart';
import 'package:panda_sportswear/screens/product_detail.dart';
import 'package:panda_sportswear/widgets/product_entry_card.dart';
          ...
          if (snapshot.data == null) {
            ...
            if (!snapshot.hasData) {
              return const Column(
                children: [
                  Text(
                    'There are no product in panda sportswear yet.',
